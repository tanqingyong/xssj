...
function cha_xun(){
	//if(check_date()){
	    $("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/sixindex/verify_detail.php');
	    $("form:first").submit();
	//}
}
...
function export_excel(){
	//if(check_date()){
		$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/sixindex/export_verify_detail.php');
	    $("form:first").submit();
	//}
}
</script>
...
<div id="coupons">
    <div class="dashboard" id="dashboard">
        <ul><?php echo mcurrent_sixindex('verify_detail'); ?></ul>
    </div>
    <div id="content" class="signup-box">
        ...
        <table cellspacing="0" cellpadding="0" >
            <tbody>
            <tr><th width="">大区</th><th width="">下单城市</th><th width="">来源城市</th><th>销售人员</th><th>商户ID</th><th>商户名称</th><th width="">产品ID</th><th width="">商品名称</th><th>一级分类</th><th width="">二级分类</th><th width="">结算单价</th><th width="">销售单价</th><th width="">验证数量</th><th>验证金额</th><th>验证毛利</th><th>折扣</th><th>产品上线时间</th><th>产品下线时间</th><th>产品截止时间</th></tr>
