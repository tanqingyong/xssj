...
function cha_xun(){
	if(check_date()){
	    $("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/moneydetail/month_sale_data_city.php');
	    $("form:first").submit();
	}
}
...
function export_excel(){
	if(check_date()){
		$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/moneydetail/export_month_sale_data_city.php');
	    $("form:first").submit();
	}
}
</script>
...
<div id="coupons">
    <div class="dashboard" id="dashboard">
        <ul><?php echo mcurrent_moneydetail('month_sale_data_city'); ?></ul>
    </div>
    <div id="content" class="signup-box">
        ...
        <!--如出现表格内没有内容，请用"&nbsp;"填充-->
          <table cellspacing="0" cellpadding="0" style="width:1400px">
            <tbody>
            <tr><th>月份</th><th>大区</th><th>城市</th><th>月销量</th><th>月销售额</th><th>月毛利</th><th>毛利率</th><th>上旬销量</th><th>上旬销售额</th><th>上旬毛利</th><th>中旬销量</th><th>中旬销售额</th><th>中旬毛利</th><th>下旬销量</th><th>下旬销售额</th><th>下旬毛利</th></tr>
