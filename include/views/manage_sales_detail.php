...
function cha_xun(){
	//if(check_date()){
	    $("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/sixindex/sales_detail.php');
	    $("form:first").submit();
	//}
}
...
function export_excel(){
	//if(check_date()){
		$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/sixindex/export_sales_detail.php');
	    $("form:first").submit();
	//}
}
</script>
...
<div id="coupons">
    <div class="dashboard" id="dashboard">
        <ul><?php echo mcurrent_sixindex('sales_detail'); ?></ul>
    </div>
    <div id="content" class="signup-box">
            ...
            <div class="chaxun_box">
             <form name='data_summary_form' method='get'><br></br>
				  ...
				  <?php if($_SESSION['grade']!=1 && $_SESSION['grade']!=2){?>
                    ...
                    <dl>
				    <dt>产品ID：</dt>
				    <dd><input type="text" style="width:87px" name="goods_id" id="goods_id" value="<?php  echo $goods_id;?>"/>
				    </dd>
				  </dl>
				   <dl>
                        <dt>类别：</dt>
        ...
        <table cellspacing="0" cellpadding="0" >
            <tbody>
            <tr><th width="">大区</th><th width="">上线城市</th><th width="">来源城市</th><th>销售人员</th><th>销售人员ID</th><th>商户ID</th><th>商户名称</th><th width="">产品ID</th><th width="">商品名称</th><th>一级分类</th><th width="">二级分类</th><th width="">结算单价</th><th width="">销售单价</th><th width="">销售数量</th><th>销售金额</th><th>折扣</th><th>正毛利</th><th>负毛利</th><th>毛利</th><th>产品上线时间</th><th>产品下线时间</th><th>产品截止时间</th></tr>
            ...
            <tr>
                ...
                <td><?php echo $data['positive_profile'];?></td>
                <td><?php echo abs($data['lose_profile']);?></td>
                <td><?php echo $data['profile'];?></td>
                <td><?php echo $data['begintime'];?></td>
