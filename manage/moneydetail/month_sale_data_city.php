...
$sql .= $condition;
$sql_count .= $condition;
$sql_count .= " group by msd.month,region.id,city.id";
...
$sql .=" group by msd.month,region.id,city.id limit $offset,$pagesize";

$datas = DB::GetQueryResult($sql,false);

echo template('manage_month_city',array('datas'=>$datas, 'pagestring'=>$pagestring, 'monthstart'=>$monthstart,'monthend'=>$monthend, 'filter_region'=>$filter_region,'filter_city'=>$filter_city,'goods_id'=>$goods_id,'page_size'=>$page_size));
?>