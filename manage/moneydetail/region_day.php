...
$sql = "select region.name as region,data_date,
...
$sql_count .= $condition." group by data_date,region.id ) as buss_day";;
$sql_sum .= $condition;
...
echo template ( 'manage_moneydetail_region_day', 
                array ( 'datas'=>$datas,'pagestring'=>$pagestring,'filter_region'=>$filter_region,'date_from'=>$date_from, 'date_end'=>$date_end, 'page_size'=>$page_size, 'sum_datas'=>$sum_datas) );
