...
$sql = "select 
month,sum(month_goodsnum) as month_goodsnum,sum(month_money) as month_money,
...
$sql .= $condition." group by msd.month,region.id";
...
$excel_name = "按大区月销售数据".$monthstart."-".$monthend;  
